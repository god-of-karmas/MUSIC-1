...
answer.extend(
    [
        ...
        InlineQueryResultArticle(
            title="ミ★ 𝘤𝘰𝘥𝘦 𝘸𝘳𝘪𝘵𝘦𝘳 ★彡",
            description=f"ıllıllı A͙b͙o͙u͙t͙ m͙y͙ code writer and repo owner ıllıllı.",
            thumb_url="https://te.legra.ph/file/fc96390beb168c19b1788.jpg",
            input_message_content=InputTextMessageContent("[  ᴄʟɪᴄᴋ     ᴍᴇ    😇](https://t.me/aboutlogesh/12)"),
        ),        
    ]
)