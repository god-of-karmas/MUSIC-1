...
import config
from LGMusic import Carbon, YouTube, app
from LGMusic.core.call import LG
from LGMusic.misc import db
from LGMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from LGMusic.utils.exceptions import AssistantErr
from LGMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from LGMusic.utils.inline.playlist import close_markup
from LGMusic.utils.pastebin import Logibin
from LGMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await LG.force_stop_stream(chat_id)
