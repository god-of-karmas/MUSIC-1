...
from LGMusic.utils.database import get_authuser_names, get_cmode
from LGMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from LGMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await LG.stop_stream(message.chat.id)
    except:
        pass
